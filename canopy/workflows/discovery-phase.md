...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /canopy:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/canopy/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/canopy/templates/discovery.md structure:
...
**Output:** `.canopy/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/canopy/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/canopy/templates/discovery.md
...
**Output:** `.canopy/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/canopy/templates/discovery.md.
...
Write `.canopy/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .canopy/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/canopy:discuss-phase [current-phase])
2. Create phase plan (/canopy:plan-phase [current-phase])
