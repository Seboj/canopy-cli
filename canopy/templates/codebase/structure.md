...
Template for `.canopy/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── canopy/        # Canopy-specific commands
...
**canopy/templates/**
- Purpose: Document templates for .canopy/ files
...
**New Slash Command:**
- Primary code: `commands/canopy/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `canopy/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `canopy/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/canopy/workflows/{name}.md`

**New Reference Document:**
- Implementation: `canopy/references/{name}.md`
